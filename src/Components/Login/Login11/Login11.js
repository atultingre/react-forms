...
const Login11 = () => {
  useEffect(() => {
    ...
    const signupHeader = document.querySelector('.login11-signup .login11-header');
    const loginHeader = document.querySelector('.login11-login .login11-header');
      ...
      <section className="login11-wrapper">
        <div className="login11-form login11-signup">
          ...
          <form action="#" className='.login11-form'>
            <input className='login11-input' type="text" placeholder="Full name" required />
            <input className='login11-input' type="text" placeholder="Email address" required />
            <input className='login11-input' type="password" placeholder="Password" required />
            <div className="checkbox">
              <input className='login11-input' type="checkbox" id="signupCheck" />
              <label className='.login11-label' htmlFor="signupCheck">I accept all terms & conditions</label>
            </div>
