...
const Registration3 = () => {
  const [isSecActive, setSecActive] = useState(false);
                ...
                <div className="details family">
                    ...
                    <div className="buttons">
                        <div className="backBtn">
                            <i className="uil uil-navigator"></i>
                            <button onClick={handleBackClick} className="btnText">Back</button>
                        </div>
                        
                        <button className="sumbit">
                            <button onClick={handleNextClick} className="btnText">Submit</button>
                            <i className="uil uil-navigator"></i>
                        </button>
                    </div>
